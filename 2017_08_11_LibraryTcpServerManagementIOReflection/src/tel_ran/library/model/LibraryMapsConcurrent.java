...
public class LibraryMapsConcurrent extends Library {
ConcurrentHashMap<Long,Book> books=new ConcurrentHashMap<>();
ConcurrentHashMap<IsbnReaderId,BookRecord> records=new ConcurrentHashMap<>();
ConcurrentSkipListMap<LocalDate,List<BookRecord>> nonreturnedRecords=new ConcurrentSkipListMap<>();
ConcurrentHashMap<Integer,Reader> readers=new ConcurrentHashMap<>();
	public LibraryMapsConcurrent(int pickPeriod) {
		super(pickPeriod);
	}
	@Override
