...
public class ArrayTest {
	...
	public void testInsert() {
		...
		assertEquals(99, (int) array.get(array.size() - 1));
		assertEquals(10, (int) array.get(N_ELEMENTS / 2));
	}

	@Test
	public void testRemoveLast() {
		assertEquals(N_ELEMENTS - 1, (int) array.removeLast());
		assertEquals(N_ELEMENTS - 2, (int) array.get(array.size() - 1));
		assertEquals(null, new Array<Integer>().removeLast());
	}
	...
	public void testRemove() {
		...
		for (int i = 0; i < numbers.length; i++) {
			assertEquals(numbers[i], (int) array.remove(numbers[i]));
			assertEquals(-1, (int) array.indexOf(numbers[i]));
	...
	public void testIndexOfPredicateOfObject() {
		assertEquals(2, array.indexOf(new PredicateEven<Integer>()));
	}
	...
	public void testLastIndexOfPredicateOfObject() {
		assertEquals(N_ELEMENTS - 2, array.lastIndexOf(new PredicateEven<Integer>()));
	}

	@Test
	public void testSort() {
		X xs[] = { new X(10), new X(4), new X(8) };
		Array<X> arrayX = new Array<X>();
	...
	public void testFilter() {
		Array<Integer> arr = array.filter(new PredicateEven<Integer>());
		assertEquals(49, arr.size());
	}

	@Test
	public void testRemoveIf() {
		array.removeIf(new PredicateEven<Integer>());
